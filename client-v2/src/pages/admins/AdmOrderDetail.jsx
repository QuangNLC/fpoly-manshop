                    ...
                    <div className="adm--order__cart--detail__pay--item__content">
                        {
                            new Intl.NumberFormat("vi-VN", {
                                style: "currency",
                                currency: "VND",
                            }).format(cart.reduce(((total, item) => (total + (item?.prDiscount) * item.quantity)), 0))
                        }
                    </div>
                </div>
                <div className="adm--order__cart--detail__pay--item">
                    ...
                    <div className="adm--order__cart--detail__pay--item__content">
                        {
                            new Intl.NumberFormat("vi-VN", {
                                style: "currency",
                                currency: "VND",
                            }).format(cart.reduce(((total, item) => (total + (item.price - item?.prDiscount) * item.quantity)), 0) + order?.shipfee)
                        }
                    </div>
                </div>
            </div>
