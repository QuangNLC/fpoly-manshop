...
import footerPayment from '../assets/imgs/footer-payment.png'
    ...
    return (
        <Container>
            <FooterColumn>
                ...
                <AboutUs>
                    <Detail>
                        Man Shop chuyên kinh doanh quần áo nam uy tín,
                        nói không với hàng nhái tại Thành Phố Hà Nội.
                    </Detail>
                    <ImageContainer>
                        <Image src={footerImg} />
                    </ImageContainer>
                ...
                <ContactList>
                    <ContactListItem>
                        ...
                        <Detail fullHeight={true}>
                            ...
                            P.Trịnh Văn Bô, Xuân Phương,
                            Nam Từ Liêm, Hà Nội
                        </Detail>
                    </ContactListItem>
                    <ContactListItem>
                        <LocalPhoneTwoToneIcon style={{fontSize: "36px", marginRight: "10px"}}/>
                        <Detail fullHeight={true}>
                            0346.410.888
                        </Detail>
                    </ContactListItem>
                    <ContactListItem>
                        <EmailTwoToneIcon style={{fontSize: "36px", marginRight: "10px"}}/>
                        <Detail fullHeight={true}>
                            s21manshop@gmail.com
                        </Detail>
                    </ContactListItem>
                </ContactList>
            </FooterColumn>
