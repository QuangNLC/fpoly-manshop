  ...
  const hanldleCheckout = () => {
    ...
    if (cartReducer.cart && cartReducer.cart.length > 0) {
      let payload = {
        ...
        total_price:
          cartReducer.cart.reduce((total, item) => {
      ...
      <Container>
        <Wrapper>
          <div className="content">
            <h2 className="text_shadows">Thông tin giỏ hàng</h2>
          </div>
          <Top>
          ...
          <Bottom>
            <Info>
              {cartReducer.cart && cartReducer.cart.length <= 0 && (
                <div className="gio-hang-trong">
                  <img
                    src="https://bizweb.dktcdn.net/100/347/970/themes/713179/assets/empty-cart.png?1593660819106"
                    alt=""
                  />
                  <Link to="/products" className="mua-ngay">
                    Mua Hàng Ngay
                  </Link>
                </div>
              )}
                    ...
                    <Product key={index}>
                      ...
                      <PriceDetail>
                        <ProductAmountContainer>
                          <div
                            onClick={() => {
                              handleClickUpdateCartItemQuantity(
                                item,
                                item.quantity + 1
                              );
                            }}
            ...
            <Summary>
              ...
              <div className="thong-tin-hoa-don">
                <div>
                  <SummaryItem>
